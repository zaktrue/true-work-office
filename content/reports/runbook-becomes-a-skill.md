...
description: "When a capable AI model writes down how a task is done, its steps, failure modes and checks, a cheaper model can execute it and still do excellent work."
