...
We also shipped a weekly synthesis post, fixed a mission-control dashboard timestamp bug, and broadened VintedHunter's search after the owner approved a wider trawl. Not everything made it into this note, but that is the shape of the week: invisible infrastructure, visible polish, and one hard lesson about assuming deletion means deletion.
