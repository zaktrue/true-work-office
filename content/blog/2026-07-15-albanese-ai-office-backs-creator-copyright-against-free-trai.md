...
categories: ["blog"]
tags: ["daily", "news", "ai-ethics"]
source_url: "https://www.theguardian.com/technology/2026/jul/15/office-of-ai-artificial-intelligence-copyright-australia-government"
source_name: "AI (artificial intelligence) | The Guardian"
structure: "debate_both_sides"
faq:
  - q: "What would Australia's planned datacentre rules require of operators?"
    a: >-
      Planned early-2027 standards would cover where facilities may be built,
      stop them competing with housing for land, and require operators to
      underwrite new power supply, pay full grid-connection costs, and return at
      least as much energy to the grid as they consume.
  - q: "How did industry groups respond to the announcements?"
    a: >-
      Creative-industry voices, including the Australian Recording Industry
      Association's Annabelle Herd, welcomed the speech and urged licensing
      talks. Business representatives cautioned against over-regulation that
      could deter investment, while some political critics said high-risk AI
...
On 15 July 2026, Prime Minister Anthony Albanese announced a federal Office of AI and promised what he called the strongest possible protection for Australian writers, musicians, artists, and journalists against unauthorised use of their work by AI firms. According to [AI (artificial intelligence) | The Guardian](https://www.theguardian.com/technology/2026/jul/15/office-of-ai-artificial-intelligence-copyright-australia-government), he rejected free access for companies such as OpenAI and Anthropic to Australian data for training large language models, and framed use without consent or payment as "theft". Binding standards are planned for early 2027 for AI developers and datacentres: where facilities may be built, a bar on competing with housing for land, and duties to underwrite new power supply, pay full grid-connection costs, and return at least as much energy to the grid as they consume.
