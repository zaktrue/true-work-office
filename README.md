...
*Generated: 2026-02-12 06:00 UTC*
...
- `_extract_metadata(self, line: str) -> Dict[<ast.Tuple object at 0x76bdc1a43010>]` - Extract additional metadata from log line
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc1a91b50>]` - Get log statistics
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc1ab4a10>]` - Get aggregation statistics
...
- `detect_anomalies(self, entries: List[Any]) -> List[<ast.Subscript object at 0x76bdc1bab490>]` - Detect statistical anomalies in log patterns
- `generate_summary(self, entries: List[Any]) -> Dict[<ast.Tuple object at 0x76bdc1bbd050>]` - Generate comprehensive pattern summary
- `analyze(self, entries: List[Any]) -> Dict[<ast.Tuple object at 0x76bdc1bd1d90>]` - Analyze trends in log entries
...
- `get_feature_status() -> Dict[<ast.Tuple object at 0x76bdca700590>]` - Check status of all features
...
- `detect_priority(self, content: str, filename: str) -> Tuple[<ast.Tuple object at 0x76bdca2f0dd0>]` - Detect priority and category from content.
...
- `discover_capabilities(self, category: Optional[str], tags: Optional[<ast.Subscript object at 0x76bdc388ff90>], agent_id: Optional[str], query: Optional[str], status: str) -> List[Capability]` - Discover capabilities matching criteria
...
- `discover(self, category: Optional[str], tags: Optional[<ast.Subscript object at 0x76bdc38fefd0>], query: Optional[str]) -> List[Capability]` - Discover capabilities from other agents
...
- `__init__(self)`
- `check_heartbeat(self, agent: str) -> Dict[<ast.Tuple object at 0x76bdc397e550>]` - Check an agent's heartbeat status
- `count_recent_outputs(self, agent: str, hours: int) -> int` - Count agent outputs in last N hours
- `get_email_status(self, agent: str) -> Optional[<ast.Subscript object at 0x76bdc39a0150>]` - Check email inbox for agents with email
- `get_predictive_tasks(self, agent: str) -> List[<ast.Subscript object at 0x76bdc39a2cd0>]` - Get predictive tasks assigned to this agent
- `generate_dashboard(self) -> Dict[<ast.Tuple object at 0x76bdc39b4210>]` - Generate complete dashboard
- `generate_report(self, dashboard: Dict[<ast.Tuple object at 0x76bdc39b4790>]) -> str` - Generate human-readable report
...
- `__init__(self, publisher: str, topic: str, content: str, metadata: Dict[<ast.Tuple object at 0x76bdc6b8ebd0>], tags: List[str], priority: str, ttl_hours: int)`
...
- `publish(self, publisher: str, topic: str, content: str, metadata: Dict[<ast.Tuple object at 0x76bdc6bd4390>], tags: List[str], priority: str, target_agents: List[str]) -> str` - Publish knowledge to the hub
...
- `main()` - CLI entry point.
- `__init__(self, db_path: Path)`
- `get_health_data(self) -> Dict[<ast.Tuple object at 0x76bdc24b4190>]` - Fetch health data from database.
...
- `calculate_savings(self, num_sources: int) -> Dict[<ast.Tuple object at 0x76bdc61fda50>]` - Calculate actual token savings for batch vs separate calls
- `test(self) -> Dict[<ast.Tuple object at 0x76bdc61ff190>]` - Run validation test and return results
...
- `main()` - CLI interface
- `__init__(self)`
- `_load_triggered(self) -> Dict[<ast.Tuple object at 0x76bdc473b950>]` - Load previously triggered events
...
- `check_prep_triggers(self) -> List[<ast.Subscript object at 0x76bdc472ff50>]` - Check for events needing preparation and trigger workflows
- `_determine_prep_actions(self, event: CalendarEvent) -> List[str]` - Determine what preparation actions are needed
- `check_daily_briefing_trigger(self) -> Optional[<ast.Subscript object at 0x76bdc475afd0>]` - Check if daily briefing should be generated
- `check_event_workflow_triggers(self) -> List[<ast.Subscript object at 0x76bdc4763a10>]` - Check for workflow triggers based on calendar events
- `get_all_triggers(self) -> Dict[<ast.Tuple object at 0x76bdc4769150>]` - Get all active triggers
...
- `check_calendar_events(agent_name: str) -> Dict[<ast.Tuple object at 0x76bdc4a01cd0>]` - Check calendar for events needing attention
...
- `get_event_workflow_context() -> Dict[<ast.Tuple object at 0x76bdc49bbbd0>]` - Get context for event-based workflows
- `log_calendar_check(agent_name: str, result: Dict[<ast.Tuple object at 0x76bdc481cd50>])` - Log calendar check to agent's log file
...
- `compress_before_model(messages: List[<ast.Subscript object at 0x76bdc451a790>], model: str) -> List[<ast.Subscript object at 0x76bdc451b290>]` - One-liner function to compress conversation before sending to model
- `main()` - Test the integration
- `__init__(self)`
- `process_conversation(self, conversation: List[<ast.Subscript object at 0x76bdc4701e90>], force_check: bool) -> List[<ast.Subscript object at 0x76bdc46fdc10>]` - Process conversation and compress if approaching token limits
- `process_for_model(self, messages: List[<ast.Subscript object at 0x76bdc46fd590>], model: str) -> List[<ast.Subscript object at 0x76bdc468eed0>]` - Process messages specifically before sending to a model
...
- `get_severity_for_file(self, file_path: Path) -> Tuple[<ast.Tuple object at 0x76bdc8349690>]` - Get severity and auto_restore setting for a file
...
- `restore_file(self, file_path: Path, event_id: str) -> Tuple[<ast.Tuple object at 0x76bdc8364390>]` - Attempt to restore a file from backup
...
- `stagger_posts(cls, platforms: List[str], base_time: datetime, stagger_minutes: int) -> Dict[<ast.Tuple object at 0x76bdc78df310>]` - Stagger posts across platforms to maximize reach
- `__init__(self, db_path: Path)`
...
- `_find_issues(self, content: str, content_type: str) -> List[<ast.Subscript object at 0x76bdc4957710>]` - Find specific issues in content
...
- `load_recent_conversation() -> Optional[<ast.Subscript object at 0x76bdc2e54190>]` - Load recent conversation from session history
...
- `get_context_dict(agent_name: str, task_type: str, max_items: Optional[int]) -> Dict[<ast.Tuple object at 0x76bdc23e4d50>]` - Get context as a dictionary for programmatic use.
...
- `_load_daily_logs(self, days: int) -> List[<ast.Subscript object at 0x76bdc2328d10>]` - Load recent daily logs with their dates
...
- `get_context_for_agent(self, agent_name: str, task_type: str, max_items: Optional[int], include_categories: Optional[<ast.Subscript object at 0x76bdc23ad2d0>]) -> Dict[<ast.Tuple object at 0x76bdc23b90d0>]` - Get relevant context for a specific agent and task.
- `_generate_summary(self, items: List[ContextItem]) -> str` - Generate a natural language summary of context
- `_generate_quick_facts(self, items: List[ContextItem]) -> Dict[<ast.Tuple object at 0x76bdc23d1e50>]` - Generate quick reference facts from context
- `format_context_for_prompt(self, context: Dict[<ast.Tuple object at 0x76bdc23d23d0>]) -> str` - Format context as a string suitable for injection into agent prompts.
...
- `get_statistics() -> Dict[<ast.Tuple object at 0x76bdc8a799d0>]` - Convenience function to get coordination statistics
- `main()` - CLI for testing and debugging
- `__new__(cls)`
- `__init__(self)`
...
- `_load_active_themes(self) -> Dict[<ast.Tuple object at 0x76bdc8beb550>]` - Load active themes
...
- `get_coordination_context(self, agent: str, task_type: str) -> Dict[<ast.Tuple object at 0x76bdc8a46d90>]` - Get coordination context for an agent.
- `format_coordination_for_prompt(self, context: Dict[<ast.Tuple object at 0x76bdc8a47310>]) -> str` - Format coordination context as a string for agent prompts.
- `mark_theme_complete(self, theme: str)` - Mark a theme as completed
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc8a6db10>]` - Get coordination statistics
...
- `_calculate_tf_idf(self, content: str) -> Dict[<ast.Tuple object at 0x76bdc556fc90>]` - Calculate TF-IDF-like scores for topic detection
...
- `main()` - CLI interface
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc86cead0>]`
- `__post_init__(self)`
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc86c6290>]`
- `__init__(self)`
...
- `get_calendar_events(self, days: int) -> List[<ast.Subscript object at 0x76bdc8520550>]` - Get upcoming calendar events with full details
- `get_events_needing_prep(self) -> List[<ast.Subscript object at 0x76bdc8522190>]` - Get conferences/speaking engagements needing preparation
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc853fcd0>]` - Get workflow statistics
...
- `_parse_activities_from_log(self, log_content: str) -> Dict[<ast.Tuple object at 0x76bdc712fa90>]` - Parse activities from daily log content
...
- `_extract_achievements(self, activities: Dict[<ast.Tuple object at 0x76bdc7186b50>]) -> List[str]` - Extract notable achievements from activities
- `_identify_focus_areas(self, activities: Dict[<ast.Tuple object at 0x76bdc716e3d0>], blockers: List[Dict]) -> List[str]` - Identify current focus areas based on activities and blockers
- `_calculate_metrics(self, activities: Dict[<ast.Tuple object at 0x76bdc7165ad0>], blockers: List[Dict]) -> Dict` - Calculate team metrics
- `_check_heartbeat_status(self, agent_id: str) -> Tuple[<ast.Tuple object at 0x76bdc7144910>]` - Check heartbeat status for an agent
...
- `save_standup(self, report: StandupReport, format: str) -> Dict[<ast.Tuple object at 0x76bdc7020b50>]` - Save standup report in specified format(s)
- `get_comparison_with_yesterday(self) -> Dict[<ast.Tuple object at 0x76bdc702c290>]` - Compare today's standup with yesterday's
...
- `get_standup_status() -> Dict[<ast.Tuple object at 0x76bdc424a490>]` - Get current standup status for heartbeat integration
- `get_standup_summary() -> str` - Get a brief standup summary for display in heartbeat
- `check_standup_for_action() -> Dict[<ast.Tuple object at 0x76bdc4264f50>]` - Check if standup requires any action
...
- `run_dashboard_script(self, script_name: str, script_args: List[str]) -> Tuple[<ast.Tuple object at 0x76bdc2ebed10>]` - Run a dashboard generation script
...
- `send_email_with_tracking(self, subject: str, body: str, briefing_type: str, is_critical: bool) -> Tuple[<ast.Tuple object at 0x76bdc417a2d0>]` - Send email with delivery tracking
...
- `extract_functions(self) -> List[<ast.Subscript object at 0x76bdc6380dd0>]` - Extract all function definitions with docstrings.
- `extract_classes(self) -> List[<ast.Subscript object at 0x76bdc6370610>]` - Extract all class definitions with docstrings.
- `extract_imports(self) -> List[str]` - Extract import statements.
- `_extract_args(self, args: ast.arguments) -> List[<ast.Subscript object at 0x76bdc6364cd0>]` - Extract function arguments.
...
- `get_documentation_score(self) -> Dict[<ast.Tuple object at 0x76bdc63b4610>]` - Calculate documentation coverage score.
...
- `parse_all(self) -> List[<ast.Subscript object at 0x76bdc6397450>]` - Parse all Python files.
- `generate_module_docs(self) -> Dict[<ast.Tuple object at 0x76bdc6394850>]` - Generate documentation for all modules.
- `calculate_coverage(self) -> Dict[<ast.Tuple object at 0x76bdc638cad0>]` - Calculate documentation coverage for all files.
...
- `__init__(self, project_path: Path)`
- `get_commits(self, since_days: int) -> List[<ast.Subscript object at 0x76bdc6221110>]` - Get git commits since specified days ago.
...
- `run_full_update(self) -> Dict[<ast.Tuple object at 0x76bdc626cf10>]` - Run complete documentation update.
...
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc5e6cb50>]`
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc5e69b10>]`
- `__init__(self)`
...
- `route_by_capability(self, capability: str, message: Dict[<ast.Tuple object at 0x76bdc5eb43d0>], strategy: RoutingStrategy, exclude: List[str]) -> Optional[str]` - Route to a node with specific capability.
- `route_message(self, source: str, target: str, message_type: str, payload: Dict[<ast.Tuple object at 0x76bdc5ebf390>]) -> Tuple[<ast.Tuple object at 0x76bdc5edcfd0>]` - Route a message from source to target.
- `_find_alternate_target(self, original_target: str, message_type: str, payload: Dict[<ast.Tuple object at 0x76bdc5edd850>]) -> Optional[str]` - Find an alternate target when original is unavailable
- `record_delivery_failure(self, node_id: str) -> bool` - Record a delivery failure to a node
- `get_route_stats(self) -> Dict[<ast.Tuple object at 0x76bdc5ef5010>]` - Get routing statistics
...
- `get_external_data() -> Dict[<ast.Tuple object at 0x76bdc45896d0>]` - Convenience function to fetch all external data
- `__init__(self)`
- `fetch_calendar_events(self, days_ahead: int) -> List[<ast.Subscript object at 0x76bdc453a8d0>]` - Fetch upcoming calendar events.
- `fetch_email_topics(self, days: int) -> Dict[<ast.Tuple object at 0x76bdc4557990>]` - Analyze recent emails for recurring topics.
- `fetch_weather(self) -> Optional[<ast.Subscript object at 0x76bdc455f950>]` - Fetch London weather.
- `fetch_news_topics(self) -> List[<ast.Subscript object at 0x76bdc4571f10>]` - Fetch recent news from blogwatcher scan.
- `fetch_recent_outputs(self, hours: int) -> List[<ast.Subscript object at 0x76bdc457ba50>]` - Fetch recent agent outputs from file system.
- `fetch_all(self) -> Dict[<ast.Tuple object at 0x76bdc4588a50>]` - Fetch all external data sources.
...
- `get_rotation_report(self) -> Dict[<ast.Tuple object at 0x76bdc783d0d0>]` - Generate rotation status report.
...
- `route_request(self, service_name: str, request_data: Any) -> Dict[<ast.Tuple object at 0x76bdc69132d0>]` - Route a request to a service instance.
- `health_check(self, service_name: str) -> Dict[<ast.Tuple object at 0x76bdc6929110>]` - Perform health check on a service.
- `get_mesh_status(self) -> Dict[<ast.Tuple object at 0x76bdc69375d0>]` - Get overall mesh status.
...
- `setup_mfa(self, user_id: str) -> Tuple[<ast.Tuple object at 0x76bdc894f210>]` - Set up MFA for a user.
...
- `verify(self, user_id: str, code: str) -> Tuple[<ast.Tuple object at 0x76bdc897fc10>]` - Verify code (TOTP or backup).
- `get_status(self, user_id: str) -> Dict` - Get MFA status for user.
- `disable_mfa(self, user_id: str) -> bool` - Disable MFA for user.
- `regenerate_backup_codes(self, user_id: str) -> Optional[<ast.Subscript object at 0x76bdc898c510>]` - Generate new backup codes for user.
...
- `get_metrics(self) -> Dict[<ast.Tuple object at 0x76bdc8c68290>]` - Get incident metrics.
...
- `main()` - Main entry point.
- `__init__(self, storage_path: str)`
- `record_metric(self, name: str, value: float, metric_type: str, unit: str, tags: Optional[<ast.Subscript object at 0x76bdc74b1f50>])` - Record a metric data point.
- `get_metric(self, name: str) -> Optional[MetricSeries]` - Get a metric series by name.
- `aggregate_window(self, name: str, window_seconds: int) -> Dict[<ast.Tuple object at 0x76bdc74a1c90>]` - Aggregate metric over a time window.
...
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc74a67d0>]` - Generate comprehensive metrics report.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc4050410>]` - Get cache statistics.
- `get_cache_contents(self) -> List[<ast.Subscript object at 0x76bdc4053190>]` - Get list of cached entries.
...
- `consume(self, tokens: int) -> Tuple[<ast.Tuple object at 0x76bdc54c4e10>]` - Try to consume tokens.
- `get_status(self) -> Dict` - Get current bucket status.
- `__init__(self, max_requests: int, window_seconds: int)`
- `consume(self, tokens: int) -> Tuple[<ast.Tuple object at 0x76bdc54b7a10>]` - Try to consume request slot.
...
- `check_rate_limit(self, endpoint: str, client_id: str) -> Tuple[<ast.Tuple object at 0x76bdc54b8e10>]` - Check if request is within rate limit.
...
- `compare_snapshots(self, snapshot1: MemorySnapshot, snapshot2: MemorySnapshot) -> Dict[<ast.Tuple object at 0x76bdc4a35090>]` - Compare two memory snapshots.
- `detect_leaks(self, threshold_mb: float) -> List[<ast.Subscript object at 0x76bdc4a314d0>]` - Detect potential memory leaks.
- `get_object_counts(self) -> Dict[<ast.Tuple object at 0x76bdc4a52450>]` - Get counts of object types in memory.
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc4a5f410>]` - Generate memory profiling report.
...
- `add_exporter(self, exporter: Callable[<ast.Tuple object at 0x76bdc567e890>])` - Add an exporter.
...
- `get_alert_summary(self) -> Dict[<ast.Tuple object at 0x76bdc9124f50>]` - Get summary of alerts.
...
- `classify_message(self, message: str) -> Tuple[<ast.Tuple object at 0x76bdc82b8cd0>]` - Classify message type and severity.
...
- `_detect_rare_patterns(self, current_patterns: Dict[<ast.Tuple object at 0x76bdc82be410>])` - Detect patterns that are rare in baseline but appearing now.
- `_detect_spikes(self, current_patterns: Dict[<ast.Tuple object at 0x76bdc82f9fd0>])` - Detect pattern frequency spikes.
- `_detect_error_spikes(self, error_counts: Dict[<ast.Tuple object at 0x76bdc830b4d0>], total_counts: Dict[<ast.Tuple object at 0x76bdc830b810>])` - Detect error rate spikes.
...
- `get_page_metrics(self, page_path: Optional[str], hours: int) -> Dict[<ast.Tuple object at 0x76bdc599e210>]` - Get performance metrics for pages.
- `get_interaction_metrics(self, hours: int) -> Dict[<ast.Tuple object at 0x76bdc59d0550>]` - Get interaction performance metrics.
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc59d3d90>]` - Generate comprehensive UX report.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc76ed7d0>]` - Get pool statistics.
...
- `get_metrics(self) -> Dict[<ast.Tuple object at 0x76bdc8193f90>]` - Get current system metrics.
...
- `get_optimization_report(self) -> Dict[<ast.Tuple object at 0x76bdc6b12590>]` - Generate comprehensive optimization report.
...
- `get_file_metadata(self, filepath: Path) -> Dict[<ast.Tuple object at 0x76bdc52e5c90>]` - Get file metadata.
...
- `get_report(self) -> Dict[<ast.Tuple object at 0x76bdc5119a50>]` - Generate drift detection report.
...
- `generate_from_template(self, template_name: str, environment: str, variables: Dict[<ast.Tuple object at 0x76bdc42d19d0>]) -> str` - Generate config from template with variable substitution.
- `_substitute_variables(self, content: str, variables: Dict[<ast.Tuple object at 0x76bdc42c9490>]) -> str` - Substitute ${VAR} or {{ var }} patterns in content.
...
- `validate_generated(self, config_path: str) -> Dict[<ast.Tuple object at 0x76bdc42e3a10>]` - Validate a generated configuration file.
...
- `_run_git(self, args: List[str], check: bool) -> Tuple[<ast.Tuple object at 0x76bdc4657dd0>]` - Run a git command and return result.
...
- `register_handler(self, channel: Channel, handler: Callable[<ast.Tuple object at 0x76bdc6e17610>])` - Register a handler for a channel.
- `route(self, notification: Notification) -> Dict[<ast.Tuple object at 0x76bdc6fe8e90>]` - Route notification to appropriate channels.
- `send(self, title: str, message: str, severity: Severity, channels: Optional[<ast.Subscript object at 0x76bdc6fe8610>], metadata: Optional[Dict]) -> Dict[<ast.Tuple object at 0x76bdc6e19b90>]` - Send a notification.
...
- `execute_policy(self, policy: RetentionPolicy, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc4de8190>]` - Execute a single retention policy.
- `run_all_policies(self, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc4dfc750>]` - Execute all retention policies.
- `get_storage_stats(self) -> Dict[<ast.Tuple object at 0x76bdc4e04b90>]` - Get current storage statistics.
...
- `verify_tar_archive(self, archive_path: Path) -> Tuple[<ast.Tuple object at 0x76bdc35f4bd0>]` - Verify tar archive can be opened and is not corrupted.
- `check_backup_age(self, backup_path: Path, max_age_hours: int) -> Tuple[<ast.Tuple object at 0x76bdc35f15d0>]` - Check if backup is within acceptable age.
...
- `should_alert(self) -> Tuple[<ast.Tuple object at 0x76bdc34778d0>]` - Determine if alert should be sent based on verification results.
...
- `run_all_tests(self) -> Dict[<ast.Tuple object at 0x76bdc3c2e150>]` - Run all integration tests.
...
- `apply_migration(self, target_version: Optional[int], dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc8acb810>]` - Apply pending migrations up to target version.
- `rollback_migration(self, steps: int, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc8ab8150>]` - Rollback the last N migrations.
- `_get_target_db(self) -> str` - Get the target database path from environment or default.
- `get_status(self) -> Dict[<ast.Tuple object at 0x76bdc8af1650>]` - Get migration status.
- `verify_checksums(self) -> List[<ast.Subscript object at 0x76bdc8afc810>]` - Verify migration checksums haven't been tampered with.
...
- `create_flag(self, name: str, flag_type: FlagType, enabled: bool, percentage: int, user_segments: Optional[<ast.Subscript object at 0x76bdc69ae510>], start_time: Optional[str], end_time: Optional[str], metadata: Optional[Dict]) -> FeatureFlag` - Create a new feature flag.
...
- `is_enabled(self, flag_name: str, user_id: Optional[str], user_segments: Optional[<ast.Subscript object at 0x76bdc69c3ed0>]) -> bool` - Check if a feature is enabled for a user.
...
- `audit_requirements_file(self, filepath: Path) -> Dict[<ast.Tuple object at 0x76bdc5feec50>]` - Audit a requirements.txt file.
- `run_full_audit(self) -> Dict[<ast.Tuple object at 0x76bdc5e14910>]` - Run complete dependency audit.
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc5e28510>]` - Generate audit report.
...
- `get_budget_status(self, hours: int) -> Dict[<ast.Tuple object at 0x76bdc5f40150>]` - Get current budget status across all pages.
- `get_trends(self, metric: str, days: int) -> Dict[<ast.Tuple object at 0x76bdc5f18d10>]` - Get performance trends for a metric.
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc5f49b50>]` - Generate comprehensive performance budget report.
- `print_report(self)` - Print report to console.
...
- `calculate_multiwindow(self, slo_name: str, slo_target: float, windows: List[<ast.Subscript object at 0x76bdc7ad7010>], alert_thresholds: Optional[Dict]) -> Dict` - Calculate budget across multiple time windows.
- `should_page(self, slo_name: str) -> Tuple[<ast.Tuple object at 0x76bdc7b02f90>]` - Determine if paging is required based on burn rate.
...
- `main()` - Main entry point.
- `__init__(self, service_name: str)`
- `start_trace(self, operation_name: str, tags: Optional[<ast.Subscript object at 0x76bdc3f8d810>]) -> str` - Start a new trace.
- `start_span(self, trace_id: str, operation_name: str, parent_id: Optional[str], tags: Optional[<ast.Subscript object at 0x76bdc3f874d0>]) -> str` - Start a new span within a trace.
- `end_span(self, span_id: str, status: SpanStatus, tags: Optional[<ast.Subscript object at 0x76bdc3f83fd0>])` - End a span.
...
- `analyze_trace(self, trace_id: str) -> Dict[<ast.Tuple object at 0x76bdc3f8b910>]` - Analyze a trace for performance insights.
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc3f89b50>]` - Get tracer statistics.
...
- `get_slo_status(self, slo_id: str) -> Dict[<ast.Tuple object at 0x76bdc7c8ddd0>]` - Get current status of an SLO.
- `check_all_slos(self) -> List[<ast.Subscript object at 0x76bdc7c8fe90>]` - Check status of all SLOs.
- `get_breach_history(self, slo_id: Optional[str], days: int) -> List[<ast.Subscript object at 0x76bdc7c90210>]` - Get SLO breach history.
- `generate_report(self, days: int) -> Dict[<ast.Tuple object at 0x76bdc7c99050>]` - Generate SLO compliance report.
...
- `create_experiment(self, name: str, experiment_type: str, target: str, duration: int, intensity: float, parameters: Optional[<ast.Subscript object at 0x76bdc62aabd0>]) -> str` - Create a new chaos experiment.
- `run_experiment(self, exp_id: str, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc629ee10>]` - Run a chaos experiment.
...
- `stop_experiment(self, exp_id: str) -> Dict[<ast.Tuple object at 0x76bdc6306750>]` - Stop a running experiment.
- `get_experiment_status(self, exp_id: str) -> Dict[<ast.Tuple object at 0x76bdc630c250>]` - Get experiment status.
- `list_experiments(self) -> List[<ast.Subscript object at 0x76bdc630e1d0>]` - List all experiments.
- `cpu_load()`
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc6eeab10>]` - Get webhook statistics.
...
- `publish(self, event_type: str, payload: Dict[<ast.Tuple object at 0x76bdc31cfb50>], priority: EventPriority, source: str, correlation_id: Optional[str]) -> Optional[Event]` - Publish an event to the bus.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc3046bd0>]` - Get event bus statistics.
...
- `get_test_history(self, limit: int) -> List[<ast.Subscript object at 0x76bdc30ede90>]` - Get history of load tests.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc229fc90>]` - Get load balancer statistics.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc4141bd0>]` - Get throttler statistics.
...
- `check_html(self, html_content: str, target_level: WCAGLevel) -> Dict[<ast.Tuple object at 0x76bdc5bfc210>]` - Check HTML content for accessibility issues.
...
- `_generate_summary(self, issues: List[AccessibilityIssue]) -> Dict[<ast.Tuple object at 0x76bdc5a4ed90>]` - Generate summary of issues.
- `check_file(self, file_path: str, target_level: WCAGLevel) -> Dict[<ast.Tuple object at 0x76bdc5a59350>]` - Check an HTML file for accessibility.
- `generate_report(self, result: Dict[<ast.Tuple object at 0x76bdc5a598d0>], output_path: Optional[str]) -> str` - Generate human-readable accessibility report.
...
- `add_transformer(self, transformer: Callable[<ast.Tuple object at 0x76bdc43b8d10>])` - Add a transformation function for events.
- `add_filter(self, filter_fn: Callable[<ast.Tuple object at 0x76bdc43b8110>])` - Add a filter function for events.
- `on_event_type(self, event_type: str, handler: Callable[<ast.Tuple object at 0x76bdc43b3310>])` - Register a handler for a specific event type.
- `ingest_event(self, event_data: Dict[<ast.Tuple object at 0x76bdc43b2610>]) -> bool` - Ingest an event into the stream.
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc43d18d0>]` - Get processor statistics.
- `create_filter_from_config(self, config: Dict[<ast.Tuple object at 0x76bdc43d1350>]) -> Callable[<ast.Tuple object at 0x76bdc43c1fd0>]` - Create a filter function from configuration.
- `create_transformer_from_config(self, config: Dict[<ast.Tuple object at 0x76bdc43c1990>]) -> Callable[<ast.Tuple object at 0x76bdc43b51d0>]` - Create a transformer function from configuration.
...
- `get_aggregate(self, event_type: Optional[str]) -> Dict[<ast.Tuple object at 0x76bdc4404ad0>]` - Get aggregate statistics for events.
...
- `register_collector(self, collector: Callable[<ast.Tuple object at 0x76bdc6488e90>])` - Register a metrics collector function.
- `register_exporter(self, exporter: Callable[<ast.Tuple object at 0x76bdc6483f90>])` - Register a metrics exporter function.
- `emit_metric(self, name: str, value: float, tags: Optional[<ast.Subscript object at 0x76bdc6482f50>], metric_type: str) -> bool` - Emit a metric to the pipeline.
...
- `get_aggregate(self, name: str, tags: Optional[<ast.Subscript object at 0x76bdc6492650>]) -> Optional[MetricAggregate]` - Get aggregate for a specific metric.
- `get_all_aggregates(self) -> Dict[<ast.Tuple object at 0x76bdc6490850>]` - Get all current aggregates.
- `get_stats(self) -> Dict[<ast.Tuple object at 0x76bdc6486e50>]` - Get pipeline statistics.
...
- `register_schema(self, config_type: str, schema: Dict[<ast.Tuple object at 0x76bdc68fea50>])` - Register a schema for a configuration type.
- `validate_file(self, file_path: str, config_type: Optional[str]) -> Dict[<ast.Tuple object at 0x76bdc68ed990>]` - Validate a configuration file.
- `validate(self, config: Any, config_type: str, path: str) -> Dict[<ast.Tuple object at 0x76bdc68e4610>]` - Validate configuration against registered schema and rules.
- `_validate_against_schema(self, config: Any, schema: Dict[<ast.Tuple object at 0x76bdc68b7f50>], path: str) -> List[ValidationIssue]` - Validate config against a JSON schema-like structure.
...
- `generate_schema(self, config: Dict[<ast.Tuple object at 0x76bdc675d950>], title: str) -> Dict[<ast.Tuple object at 0x76bdc675fa50>]` - Generate a JSON schema from an example configuration.
- `_infer_type(self, value: Any) -> Dict[<ast.Tuple object at 0x76bdc676fe10>]` - Infer JSON schema type from a value.
...
- `__init__(self, config_path: Optional[str])`
- `_load_config(self, config_path: Optional[str]) -> Dict[<ast.Tuple object at 0x76bdc2c9f2d0>]` - Load quality gate configuration.
...
- `check_directory(self, directory: str, extensions: Optional[<ast.Subscript object at 0x76bdc2c96610>]) -> QualityReport` - Check all files in a directory.
...
- `check_updates(self, manager: Optional[str]) -> Dict[<ast.Tuple object at 0x76bdc3d297d0>]` - Check for available dependency updates.
- `_check_pip_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d24390>]` - Check for pip package updates.
- `_check_npm_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d60b10>]` - Check for npm package updates.
- `_check_yarn_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d37410>]` - Check for yarn package updates.
- `_check_poetry_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d69410>]` - Check for poetry package updates.
- `_check_cargo_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d6a110>]` - Check for cargo package updates.
- `_check_gomod_updates(self) -> Dict[<ast.Tuple object at 0x76bdc3d7f610>]` - Check for go module updates.
- `_determine_update_type(self, current: str, latest: str) -> UpdateType` - Determine the type of update based on version change.
- `_parse_version(self, version: str) -> Tuple[<ast.Tuple object at 0x76bdc3d90550>]` - Parse a semantic version string.
- `apply_updates(self, manager: Optional[str], update_type: Optional[str], dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc3d98e10>]` - Apply dependency updates.
- `generate_report(self, check_result: Dict[<ast.Tuple object at 0x76bdc3d99390>]) -> str` - Generate a human-readable update report.
...
- `sync_documentation(self, sources: Optional[<ast.Subscript object at 0x76bdc9265950>], targets: Optional[<ast.Subscript object at 0x76bdc9265650>]) -> Dict[<ast.Tuple object at 0x76bdc925da10>]` - Synchronize documentation from sources to targets.
- `_sync_file(self, source: Path, targets: Optional[<ast.Subscript object at 0x76bdc925d390>]) -> DocSyncResult` - Synchronize a single file.
...
- `_md_to_json(self, content: str, source_path: str) -> Dict[<ast.Tuple object at 0x76bdc92a0250>]` - Convert Markdown to structured JSON.
- `check_consistency(self) -> Dict[<ast.Tuple object at 0x76bdc92a8110>]` - Check documentation consistency across formats.
- `generate_index(self) -> str` - Generate documentation index.
...
- `__init__(self, project_path: str)`
- `analyze_project(self) -> Dict[<ast.Tuple object at 0x76bdc5759bd0>]` - Analyze entire project for dead code.
...
- `analyze_file(self, file_path: str) -> Dict[<ast.Tuple object at 0x76bdc578e690>]` - Analyze a single file for dead code.
- `_find_unused_variables(self, tree: ast.AST, findings: List[DeadCodeFinding], file_path: str)` - Find unused local variables.
- `remove_unused_imports(self, file_path: str, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc57b1790>]` - Remove unused imports from a file.
- `generate_report(self) -> str` - Generate a human-readable report.
...
- `__init__(self, project_path: str)`
- `check_file(self, file_path: str) -> Dict[<ast.Tuple object at 0x76bdc880fbd0>]` - Check a single file for type hint compliance.
- `check_project(self) -> Dict[<ast.Tuple object at 0x76bdc87dadd0>]` - Check entire project for type hint compliance.
- `_check_function(self, node: ast.FunctionDef, file_path: str)` - Check a function for type hints.
- `add_type_hints(self, file_path: str, dry_run: bool) -> Dict[<ast.Tuple object at 0x76bdc8618e90>]` - Attempt to add basic type hints to a file.
- `generate_report(self) -> str` - Generate human-readable report.
- `get_coverage_stats(self) -> Dict[<ast.Tuple object at 0x76bdc865e810>]` - Get detailed coverage statistics.
...
- `load_coverage_json(self, json_path: str) -> Dict[<ast.Tuple object at 0x76bdc5897d50>]` - Load coverage data from JSON file.
...
- `get_coverage_trend(self, historical_data: List[Dict]) -> Dict[<ast.Tuple object at 0x76bdc58cfb10>]` - Analyze coverage trend over time.
...
- `main()` - Main entry point.
- `__init__(self)`
- `_load_features(self) -> List[<ast.Subscript object at 0x76bdc8d1a410>]` - Load features from registry.
- `get_feature_by_id(self, feature_id: int) -> Optional[<ast.Subscript object at 0x76bdc8d191d0>]` - Get feature by ID.
- `run_audit(self, feature_id: int, comprehensive: bool) -> Dict[<ast.Tuple object at 0x76bdc8f0d410>]` - Run complete audit on a feature.
- `_test_discovery(self, feature: Dict[<ast.Tuple object at 0x76bdc8f0ce90>]) -> Dict[<ast.Tuple object at 0x76bdc8d17110>]` - Test 1: Verify feature files exist.
- `_test_syntax(self, feature: Dict[<ast.Tuple object at 0x76bdc8d16b90>]) -> Dict[<ast.Tuple object at 0x76bdc8d61550>]` - Test 2: Check code syntax.
- `_test_execution(self, feature: Dict[<ast.Tuple object at 0x76bdc8d61ad0>]) -> Dict[<ast.Tuple object at 0x76bdc8d77150>]` - Test 3: Execute feature and verify output.
- `_test_edge_cases(self, feature: Dict[<ast.Tuple object at 0x76bdc8d776d0>]) -> Dict[<ast.Tuple object at 0x76bdc8d84e50>]` - Test 4: Edge case testing (comprehensive only).
- `_test_integration(self, feature: Dict[<ast.Tuple object at 0x76bdc8d853d0>]) -> Dict[<ast.Tuple object at 0x76bdc8d86b10>]` - Test 5: Integration testing (comprehensive only).
- `_test_performance(self, feature: Dict[<ast.Tuple object at 0x76bdc8d87090>]) -> Dict[<ast.Tuple object at 0x76bdc8d90810>]` - Test 6: Performance testing (comprehensive only).
- `_determine_status(self, tests: Dict[<ast.Tuple object at 0x76bdc8d90d90>]) -> str` - Determine overall feature status.
- `_generate_recommendations(self, feature: Dict[<ast.Tuple object at 0x76bdc8d92fd0>], audit: Dict[<ast.Tuple object at 0x76bdc8d93310>]) -> List[str]` - Generate recommendations based on audit results.
- `_save_audit_report(self, feature_id: int, audit: Dict[<ast.Tuple object at 0x76bdc8da56d0>])` - Save audit report to file.
- `_print_summary(self, audit: Dict[<ast.Tuple object at 0x76bdc8dbe110>])` - Print audit summary.
...
- `load_tracking() -> Dict[<ast.Tuple object at 0x76bdc4e1d8d0>]` - Load feature deployment tracking data
- `save_tracking(tracking: Dict[<ast.Tuple object at 0x76bdc4e1d3d0>])` - Save feature deployment tracking data
...
- `notify_feature_deployed(feature_num: int, feature_title: str, description: str, docs_link: Optional[str], deployed_by: str, priority: str, additional_notes: Optional[str], recipient: str, sender_agent: str, allow_duplicates: bool) -> Dict[<ast.Tuple object at 0x76bdc4e41ad0>]` - Send a standardized feature deployment notification email
- `send_test_email(recipient: str) -> Dict[<ast.Tuple object at 0x76bdc4e43410>]` - Send a test deployment notification email
- `get_deployment_stats() -> Dict[<ast.Tuple object at 0x76bdc4e4e6d0>]` - Get statistics about feature deployments and notifications
- `main()`
...
- `get_last_check_date(feature_id: int) -> Tuple[<ast.Tuple object at 0x76bdc2e84bd0>]` - Get the last check date for a feature.
- `get_error_count(feature_id: int, feature_name: str) -> int` - Count recent errors for a feature from logs.
- `get_cron_status(feature_id: int, feature_name: str) -> Dict[<ast.Tuple object at 0x76bdc2e71b50>]` - Check if feature has a cron job scheduled.
- `calculate_risk_score(feature: Dict[<ast.Tuple object at 0x76bdc2e34550>], error_count: int, cron_status: Dict) -> int` - Calculate risk score (1-10).
- `calculate_complexity_score(feature: Dict[<ast.Tuple object at 0x76bdc2ebf950>]) -> int` - Estimate complexity score (1-10).
- `calculate_priority(feature: Dict[<ast.Tuple object at 0x76bdc2ea1e90>]) -> Dict[<ast.Tuple object at 0x76bdc2e95650>]` - Calculate comprehensive priority score for a feature.
- `load_features() -> List[<ast.Subscript object at 0x76bdc2ec4950>]` - Load features from registry.
- `save_priorities(priorities: List[<ast.Subscript object at 0x76bdc2ec4f50>])` - Save priorities to database.
- `get_priority_queue(limit: int) -> List[<ast.Subscript object at 0x76bdc2ecfbd0>]` - Get top N features by priority.
- `main()` - Main entry point.
- `format_priority(p: Dict[<ast.Tuple object at 0x76bdc2ef9e90>]) -> str` - Format priority for display.
...
- `__init__(self, workspace_path: str)`
- `scan_all_features(self) -> Dict[<ast.Tuple object at 0x76bdc66d7a90>]` - Scan workspace for all features.
...
- `detect_feature_usage(self) -> Dict[<ast.Tuple object at 0x76bdc3c83d90>]` - Detect usage of all features by analyzing files and logs
- `log_feature_event(self, feature_id: int, event_type: str, details: Dict[<ast.Tuple object at 0x76bdc3c833d0>])` - Log a feature usage event
- `calculate_statistics(self, usage_data: Dict[<ast.Tuple object at 0x76bdc3c80dd0>]) -> Dict[<ast.Tuple object at 0x76bdc3c695d0>]` - Calculate overall statistics
- `_get_suggestion(self, feature_id: int, usage: Dict[<ast.Tuple object at 0x76bdc3c68f50>]) -> str` - Generate a suggestion for an underutilized feature
- `generate_dashboard_html(self, usage_data: Dict[<ast.Tuple object at 0x76bdc3cece50>], stats: Dict[<ast.Tuple object at 0x76bdc3ced3d0>]) -> str` - Generate an HTML dashboard
- `_generate_critical_alerts(self, stats: Dict[<ast.Tuple object at 0x76bdc3d0cd50>]) -> str` - Generate HTML for critical feature alerts
- `_generate_suggestions(self, stats: Dict[<ast.Tuple object at 0x76bdc3d0f650>]) -> str` - Generate HTML for optimization suggestions
- `generate_report(self, usage_data: Dict[<ast.Tuple object at 0x76bdc3b19a50>], stats: Dict[<ast.Tuple object at 0x76bdc3b19fd0>]) -> str` - Generate a markdown report
...
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc45a6c90>]`
- `__init__(self)`
- `_load_config(self) -> Dict[<ast.Tuple object at 0x76bdc459e710>]` - Load calendar configuration
- `_save_config(self, config: Dict[<ast.Tuple object at 0x76bdc459e190>])` - Save calendar configuration
...
- `_parse_event(self, event: Dict[<ast.Tuple object at 0x76bdc459a190>]) -> Optional[CalendarEvent]` - Parse Google Calendar event into CalendarEvent
- `_classify_event(self, summary: str, description: str, is_conference: bool) -> str` - Classify event type based on content
- `_get_cached_events(self, days: int) -> Optional[<ast.Subscript object at 0x76bdc45fcd10>]` - Get cached events if still valid
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc4431050>]` - Get calendar statistics
...
- `_execute_healing_action(self, action_type: str, params: Dict) -> Tuple[<ast.Tuple object at 0x76bdc4b56510>]` - Execute a specific healing action
...
- `get_incident_summary(self) -> Dict[<ast.Tuple object at 0x76bdc4b844d0>]` - Get summary of incident status
- `_row_to_incident(self, row) -> Incident` - Convert database row to Incident object
- `run_response_cycle(self) -> Dict[<ast.Tuple object at 0x76bdc4b9b610>]` - Main response cycle - detect, heal, escalate
...
- `__post_init__(self)`
- `__init__(self)`
- `_load_models(self) -> Dict[<ast.Tuple object at 0x76bdc9003750>]` - Load model configurations.
...
- `execute_with_fallback(self, task_type: str, call_fn: Callable, preferred_model: Optional[str], max_retries: int) -> Tuple[<ast.Tuple object at 0x76bdc8eaa990>]` - Execute a task with automatic fallback on failure.
...
- `main()` - CLI entry point
- `__init__(self, workspace_path: str)`
- `_compile_patterns(self) -> Dict[<ast.Tuple object at 0x76bdc5ce4890>]` - Compile regex patterns for query type detection
- `parse_query(self, query: str) -> ParsedQuery` - Parse a natural language query into structured components
- `_extract_filters(self, query: str) -> Dict[<ast.Tuple object at 0x76bdc5b63150>]` - Extract additional filters from query
...
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc858d550>]` - Convert to dictionary
- `from_dict(cls, data: Dict[<ast.Tuple object at 0x76bdc857cc10>]) -> 'MeshNode'` - Create from dictionary
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc85e6490>]`
- `from_dict(cls, data: Dict[<ast.Tuple object at 0x76bdc85e5f10>]) -> 'Route'`
- `__init__(self)`
...
- `get_mesh_topology(self) -> Dict[<ast.Tuple object at 0x76bdc845b650>]` - Get the current mesh topology
...
- `record_agent_performance(agent: str, task_type: str, dimension_scores: Dict[<ast.Tuple object at 0x76bdc436e190>], **kwargs) -> int` - Quick function to record performance
- `get_agent_trends(agent: str, days: int) -> List[TrendResult]` - Get trends for an agent
- `check_system_health() -> Dict[<ast.Tuple object at 0x76bdc4378710>]` - Check overall system health
...
- `_load_config(self) -> Dict` - Load configuration from file
- `_save_config(self)` - Save configuration to file
- `record_performance(self, agent: str, task_type: str, dimension_scores: Dict[<ast.Tuple object at 0x76bdc4473210>], response_time_ms: int, output_tokens: int, metadata: Optional[Dict]) -> int` - Record a performance measurement.
- `_calculate_overall_score(self, dimension_scores: Dict[<ast.Tuple object at 0x76bdc4466190>]) -> float` - Calculate weighted overall score from dimension scores
...
- `create_alert(self, agent: str, alert_type: str, severity: str, description: str, trend_data: Optional[Dict], suggested_actions: Optional[<ast.Subscript object at 0x76bdc44cc850>]) -> int` - Create a performance alert
...
- `get_agent_summary(self, agent: str, days: int) -> Dict[<ast.Tuple object at 0x76bdc43184d0>]` - Get summary statistics for an agent
- `get_active_alerts(self, agent: Optional[str]) -> List[<ast.Subscript object at 0x76bdc4320550>]` - Get active (unresolved) alerts
...
- `get_dashboard_data(self) -> Dict[<ast.Tuple object at 0x76bdc4367350>]` - Get data formatted for dashboard display
...
- `scan_heartbeat_logs(self, hours: int) -> Dict[<ast.Tuple object at 0x76bdc779c9d0>]` - Scan agent heartbeat logs for the last N hours.
- `_parse_heartbeat_line(self, line: str, cutoff: datetime) -> Optional[Dict]` - Parse a single heartbeat log line
- `analyze_output_quality(self, agent: str, hours: int) -> Dict[<ast.Tuple object at 0x76bdc7798f10>]` - Analyze quality of agent outputs from various sources.
...
- `collect_and_record(self, hours: int) -> Dict[<ast.Tuple object at 0x76bdc77fed10>]` - Main method: collect performance data and record it.
...
- `integrate_with_health_dashboard(self) -> Dict[<ast.Tuple object at 0x76bdc538c550>]` - Enrich the agent health dashboard with performance data.
- `_health_status_from_score(self, score: float, alerts: List[Dict]) -> str` - Determine health status from score and alerts
- `record_from_task_completion(self, agent: str, task_type: str, output_file: str, metrics: Dict[<ast.Tuple object at 0x76bdc5385310>]) -> int` - Record performance from a completed task.
- `generate_daily_digest_section(self) -> str` - Generate markdown section for daily digest.
- `check_and_notify_degradation(self) -> List[<ast.Subscript object at 0x76bdc53c97d0>]` - Check for performance degradation and return notifications.
...
- `create_performance_based_task(self) -> Optional[<ast.Subscript object at 0x76bdc53e1a50>]` - Create a proactive task based on performance analysis.
- `export_for_coordination(self) -> Dict[<ast.Tuple object at 0x76bdc53f23d0>]` - Export performance data for cross-agent coordination.
...
- `get_predictive_stats() -> Dict[<ast.Tuple object at 0x76bdc7abe690>]` - Get predictive automation statistics
- `main()` - CLI for predictive automation
- `validate(cls, content: str) -> Tuple[<ast.Tuple object at 0x76bdc7bbca10>]` - Validate content matches Thomas's style.
- `__new__(cls)`
- `__init__(self)`
...
- `_fetch_external_data(self) -> Dict[<ast.Tuple object at 0x76bdc7a43110>]` - Fetch real external data for pattern detection
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc7abcf50>]` - Get predictive automation statistics
...
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc8251b90>]`
- `from_dict(cls, data: Dict[<ast.Tuple object at 0x76bdc8251610>]) -> 'FeedbackEntry'`
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc824e790>]`
- `__init__(self)`
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc8278050>]` - Get learning loop statistics
...
- `collect_health_metrics(self) -> Dict[<ast.Tuple object at 0x76bdc889c4d0>]` - Collect current health metrics from network mesh.
- `analyze_trends(self, node_id: str, metrics: List[HealthMetric]) -> Dict[<ast.Tuple object at 0x76bdc8861b10>]` - Analyze health trends to detect degradation patterns.
- `predict_failures(self) -> List[FailurePrediction]` - Generate failure predictions based on trend analysis.
- `get_optimal_maintenance_window(self, node_id: str, maintenance_type: str, risk_level: str, max_lookahead_hours: int) -> Tuple[<ast.Tuple object at 0x76bdc88d7fd0>]` - Calculate optimal maintenance window based on activity patterns.
...
- `generate_report(self) -> Dict[<ast.Tuple object at 0x76bdc873a8d0>]` - Generate comprehensive maintenance report.
...
- `calculate_semantic_relevance(self, title: str, summary: str, full_text: Optional[str]) -> Tuple[<ast.Tuple object at 0x76bdc34b2e90>]` - Calculate semantic relevance score based on Thomas's interests.
...
- `main()` - CLI interface
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc5c120d0>]`
- `from_entry(cls, entry: Dict, feed_config: Dict, feed_name: str) -> 'FeedItem'` - Create FeedItem from feedparser entry
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc5e06e50>]`
- `__init__(self)`
...
- `categorize_items(self, items: List[FeedItem]) -> Dict[<ast.Tuple object at 0x76bdc5c699d0>]` - Categorize items by priority and category
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x76bdc5caa250>]` - Get monitoring statistics
- `run(self, auto_trigger: bool) -> Dict[<ast.Tuple object at 0x76bdc5cb6b50>]` - Run full monitoring cycle
...
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc67f6310>]`
- `from_dict(cls, data: Dict[<ast.Tuple object at 0x76bdc67f5d90>]) -> 'HealingAction'`
- `to_dict(self) -> Dict[<ast.Tuple object at 0x76bdc67f2190>]`
- `__init__(self)`
...
- `get_node_health_report(self, node_id: str) -> Dict[<ast.Tuple object at 0x76bdc6668650>]` - Get detailed health report for a node
...
- `_load_agent_status(self) -> Dict[<ast.Tuple object at 0x76bdc4ec9a50>]` - Load status for all agents from daily logs
...
- `should_run_agent_check(self, agent_name: str) -> Tuple[<ast.Tuple object at 0x76bdc4edcfd0>]` - Decide if we should actively check an agent's status.
- `should_alert_thomas(self, finding: str, severity: str) -> Tuple[<ast.Tuple object at 0x76bdc4ecdf50>]` - Decide if an alert should be sent to Thomas.
...
- `get_task_priority(self, task_name: str) -> Tuple[<ast.Tuple object at 0x76bdc4d20690>]` - Get priority for a task (1-10, 10 = highest).
- `generate_daily_improvements(self) -> List[<ast.Subscript object at 0x76bdc4d2ec90>]` - Generate 3 workflow improvement suggestions based on current context.
...
- `calculate_impact_analysis(self, graph: Dict) -> Dict[<ast.Tuple object at 0x76bdc8ba47d0>]` - Calculate impact analysis for each feature.
...
- `detect_trend(values: List[float]) -> Tuple[<ast.Tuple object at 0x76bdc3a25ad0>]` - Detect trend direction and strength
...
- `query_sqlite(db_path: str, query: str) -> List[<ast.Subscript object at 0x76bdc6018d90>]` - Execute SQLite query and return results.
- `get_db_stats(db_name: str) -> Dict[<ast.Tuple object at 0x76bdc6063bd0>]` - Get statistics from a database file.
- `get_api_health_stats() -> Dict[<ast.Tuple object at 0x76bdc602ce90>]` - Get API health statistics.
- `get_incident_stats() -> Dict[<ast.Tuple object at 0x76bdc6077390>]` - Get incident statistics.
- `get_feature_retirement_stats() -> Dict[<ast.Tuple object at 0x76bdc6082fd0>]` - Get feature retirement statistics.
- `get_performance_stats() -> Dict[<ast.Tuple object at 0x76bdc608a210>]` - Get performance benchmark statistics.
- `get_research_scout_stats() -> Dict[<ast.Tuple object at 0x76bdc6091550>]` - Get research scout statistics.
- `get_model_fallback_stats() -> Dict[<ast.Tuple object at 0x76bdc60994d0>]` - Get model fallback statistics.
- `get_config_drift_stats() -> Dict[<ast.Tuple object at 0x76bdc60a0710>]` - Get configuration drift statistics.
- `get_task_prioritization_stats() -> Dict[<ast.Tuple object at 0x76bdc60a3910>]` - Get task prioritization statistics.
- `collect_all_metrics() -> Dict[<ast.Tuple object at 0x76bdc60a9590>]` - Collect metrics from all data sources.
- `generate_dashboard_html(metrics: Dict[<ast.Tuple object at 0x76bdc60a9a90>]) -> str` - Generate the unified dashboard HTML.
- `main()` - Main entry point.
...
- `__init__(self)`
- `detect_urgency(self, title: str, description: str, source: str) -> Tuple[<ast.Tuple object at 0x76bdc26e7450>]` - Analyze task and return priority level, factor scores, and detected deadline.
...
- `add_task(self, title: str, description: str, source: str, source_id: Optional[str], agent: Optional[str], deadline: Optional[datetime], metadata: Optional[<ast.Subscript object at 0x76bdc2528750>]) -> Task` - Add a new task to the prioritization queue.
- `_calculate_priority_score(self, priority: PriorityLevel, factors: Dict[<ast.Tuple object at 0x76bdc253db50>], deadline: Optional[datetime], agent: Optional[str]) -> float` - Calculate final priority score (0-100)
...
- `get_queue_summary(self) -> Dict[<ast.Tuple object at 0x76bdc25b6810>]` - Get summary statistics of the task queue
- `process_queue(self) -> Dict[<ast.Tuple object at 0x76bdc25c6190>]` - Main queue processing function.
...
- `generate_dashboard_data(self) -> Dict[<ast.Tuple object at 0x76bdc25dba90>]` - Generate data for the priority dashboard
...
- `main()` - Main entry point
- `__init__(self)`
- `_parse_heartbeat_log(self, agent: str) -> Optional[<ast.Subscript object at 0x76bdc363ad50>]` - Parse the latest heartbeat from an agent's log
...
- `_get_recent_system_alerts(self) -> List[<ast.Subscript object at 0x76bdc361b010>]` - Get recent system-wide alerts
- `_get_top_themes(self) -> List[str]` - Extract top themes from recent outputs
- `_ensure_readable_activities(self, agent_id: str, activities: List[Any]) -> List[<ast.Subscript object at 0x76bdc3660850>]` - Ensure agent has 3 readable activity bullet points with timestamps
...
- `send_email(self, to: str, subject: str, body: str, email_type: str, is_critical: Optional[bool], sender_agent: str, html_body: Optional[str], attachments: Optional[<ast.Subscript object at 0x76bdc3226c90>], allow_duplicates: bool, sender_email: Optional[str], cc: Optional[str]) -> DeliveryResult` - Universal email send with delivery confirmation.
...
- `get_pending_deliveries(self) -> Dict[<ast.Tuple object at 0x76bdc3296690>]` - Get all pending deliveries
- `get_failed_deliveries(self) -> Dict[<ast.Tuple object at 0x76bdc3297050>]` - Get all failed deliveries
...
- `validate_database(db_name: str, schema_def: Dict[<ast.Tuple object at 0x76bdc5906750>]) -> List[str]` - Validate a database against its schema definition
- `migrate_database(db_name: str, migrations: Dict[<ast.Tuple object at 0x76bdc5900710>]) -> List[str]` - Apply migrations to fix schema issues
...
- `_api_headers(field_mask: str) -> dict[<ast.Tuple object at 0x76bdc200e6d0>]`
...
- `_build_search_body(request: SearchRequest) -> dict[<ast.Tuple object at 0x76bdc2005bd0>]`
...
- `json(self) -> dict[<ast.Tuple object at 0x76bdc1e14310>]`
- `text(self) -> str`
...
- `ping() -> dict[<ast.Tuple object at 0x76bdc1e61fd0>]`
...
- `eprint(msg: str) -> None`
- `run_codexbar_cost(provider: str) -> List[<ast.Subscript object at 0x76bdc1f6ef90>]`
- `load_payload(input_path: Optional[str], provider: str) -> Dict[<ast.Tuple object at 0x76bdc1f67310>]`
- `parse_daily_entries(payload: Dict[<ast.Tuple object at 0x76bdc1f66790>]) -> List[<ast.Subscript object at 0x76bdc1f65150>]`
- `parse_date(value: str) -> Optional[date]`
- `filter_by_days(entries: List[<ast.Subscript object at 0x76bdc1f63cd0>], days: Optional[int]) -> List[<ast.Subscript object at 0x76bdc1f60f90>]`
- `aggregate_costs(entries: Iterable[<ast.Subscript object at 0x76bdc1f60890>]) -> Dict[<ast.Tuple object at 0x76bdc1fa1d90>]`
- `pick_current_model(entries: List[<ast.Subscript object at 0x76bdc1fa2290>]) -> Tuple[<ast.Tuple object at 0x76bdc1f7ad10>]`
- `usd(value: Optional[float]) -> str`
- `latest_day_cost(entries: List[<ast.Subscript object at 0x76bdc1f79890>], model: str) -> Tuple[<ast.Tuple object at 0x76bdc1f70fd0>]`
...
- `render_text_all(provider: str, totals: Dict[<ast.Tuple object at 0x76bdc1faabd0>]) -> str`
- `build_json_current(provider: str, model: str, latest_date: Optional[str], total_cost: Optional[float], latest_cost: Optional[float], latest_cost_date: Optional[str], entry_count: int) -> Dict[<ast.Tuple object at 0x76bdc1fb2450>]`
- `build_json_all(provider: str, totals: Dict[<ast.Tuple object at 0x76bdc1fb2a50>]) -> Dict[<ast.Tuple object at 0x76bdc1fb8210>]`
- `main() -> int`
...
- `get_model_defaults(model: str) -> tuple[<ast.Tuple object at 0x76bdc1dc7790>]` - Return (default_size, default_quality) for the given model.
...
- `load_config() -> Dict[<ast.Tuple object at 0x76bdc1c56150>]` - Load configuration from config.json if it exists, with defaults.
...
- `auto_route_provider(query: str, config: Dict[<ast.Tuple object at 0x76bdc1ccc750>]) -> Dict[<ast.Tuple object at 0x76bdc1ccd290>]` - Intelligently route query to the best provider.
- `explain_routing(query: str, config: Dict[<ast.Tuple object at 0x76bdc1ccd890>]) -> Dict[<ast.Tuple object at 0x76bdc1cdb790>]` - Provide detailed explanation of routing decision for debugging.
...
- `search_tavily(query: str, api_key: str, max_results: int, depth: str, topic: str, include_domains: Optional[<ast.Subscript object at 0x76bdc1d0cd50>], exclude_domains: Optional[<ast.Subscript object at 0x76bdc1d0d050>], include_images: bool, include_raw_content: bool) -> dict` - Search using Tavily (AI Research Search).
- `search_exa(query: str, api_key: str, max_results: int, search_type: str, category: Optional[str], start_date: Optional[str], end_date: Optional[str], similar_url: Optional[str], include_domains: Optional[<ast.Subscript object at 0x76bdc1b1b810>], exclude_domains: Optional[<ast.Subscript object at 0x76bdc1b1bb10>]) -> dict` - Search using Exa (Neural/Semantic Search).
- `main()`
- `__init__(self, config: Dict[<ast.Tuple object at 0x76bdc1c12990>])`
- `_calculate_signal_score(self, query: str, signals: Dict[<ast.Tuple object at 0x76bdc1c119d0>]) -> Tuple[<ast.Tuple object at 0x76bdc1cacdd0>]` - Calculate score for a signal category.
...
- `_assess_query_complexity(self, query: str) -> Dict[<ast.Tuple object at 0x76bdc1c66dd0>]` - Assess query complexity - complex queries favor Tavily.
- `_detect_recency_intent(self, query: str) -> Tuple[<ast.Tuple object at 0x76bdc1c64b90>]` - Detect if query wants recent/timely information.
- `analyze(self, query: str) -> Dict[<ast.Tuple object at 0x76bdc1c419d0>]` - Perform comprehensive query analysis.
- `route(self, query: str) -> Dict[<ast.Tuple object at 0x76bdc1ccc0d0>]` - Route query to optimal provider with confidence scoring.
...
- `_test_health_performance_integration(self) -> Tuple[<ast.Tuple object at 0x76bdc9933150>]` - Test health dashboard and performance analytics integration
- `_test_knowledge_cross_agent_integration(self) -> Tuple[<ast.Tuple object at 0x76bdc9930510>]` - Test knowledge protocol with cross-agent workflows
- `_test_alert_correlation_integration(self) -> Tuple[<ast.Tuple object at 0x76bdc992a850>]` - Test alert system with correlation dashboard
- `_test_calendar_workflow_integration(self) -> Tuple[<ast.Tuple object at 0x76bdc9928910>]` - Test calendar API with workflow triggers
- `_run_performance_benchmarks(self) -> Dict[<ast.Tuple object at 0x76bdc99100d0>]` - Run performance benchmarks
...
- `_calculate_coverage(self) -> Dict[<ast.Tuple object at 0x76bdc99be050>]` - Calculate test coverage statistics
...
- `_collect_agent_metrics(self) -> Dict[<ast.Tuple object at 0x76bdc196ba50>]` - Collect metrics for all 5 subagents.
